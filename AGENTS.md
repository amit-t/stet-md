# Agent Instructions — Redline

Read these before implementation:

1. `docs/prd/README.md`
2. `docs/prd/00-redline-master-prd.md`
...
- Thread data source of truth is the structured `redline:thread` marker. Visible blockquote is generated view.
